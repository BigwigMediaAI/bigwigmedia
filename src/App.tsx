...
import { BlogPostIntro } from "./components/BlogPostIntroduction";
import { BlogPostConclusion } from "./components/BlogPostConclusion";
  ...
  return (
    <div className=" min-w-screen min-h-screen bg-white">
      <Routes>
        ...
        <Route path="/blogpost" element={<BlogPostConclusion />} />
</Routes>
    </div>
  );
};
