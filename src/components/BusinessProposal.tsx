...
export function BusinessProposal() {
  ...
  return (
    <div className="m-auto w-full max-w-4xl rounded-lg bg-[var(--white-color)] p-6 shadow-md shadow-[var(--teal-color)]">
      ...
      <div className="mb-5">
        <label className="block text-[var(--primary-text-color)] ">Project Description</label>
        <input
      ...
      <div className="mb-5">
        <label className="block text-[var(--primary-text-color)] ">Objectives</label>
        <input
          value={objectives}
      ...
      <div className="mb-5">
        <label className="block text-[var(--primary-text-color)] ">Deliverables</label>
        <input
          value={deliverables}
      ...
      <div className="mb-5">
        <label className="block text-[var(--primary-text-color)] ">Timeline</label>
        <input
          value={timeline}
      ...
      <div className="mb-5">
        <label className="block text-[var(--primary-text-color)] ">Budget</label>
        <input
          value={budget}
