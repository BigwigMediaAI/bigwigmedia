...
export function GenerateCalenderContent() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/generatecalender?clerkId=${userId}`, {
        topic,
        tone,
        language,
        outputCount,
  ...
  return (
    <div className="m-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-xl dark:bg-[#262626]">
        ...
        <input
          ...
          placeholder="E.g., Socaial Media Campaigning"
    ...
    generatedPosts.length > 0 && (
      <div ref={resultsRef} className="border border-gray-300 rounded-md mt-6 p-5 relative ">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl text-gray-700 dark:text-gray-300">Generated Calender Content</h1>
