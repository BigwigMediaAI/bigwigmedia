...
export function GenerateProductDescription() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/createProductDescription?clerkId=${userId}`, {
        description,
        tone,
        language,
        outputCount
    ...
    <div className="m-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-md shadow-[var(--teal-color)]">
      <div className="mb-5">
        ...
        <textarea
          ...
          placeholder="e.g. A high-quality Bluetooth speaker with 20 hours of battery life and superior sound quality."
