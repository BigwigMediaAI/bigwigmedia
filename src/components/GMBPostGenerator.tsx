...
export function GMBPost() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/generateGMBPost?clerkId=${userId}`, {
        businessUpdate,
        companyName,
        tone,
        language,
  ...
  return (
    <div className="m-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-xl dark:bg-[#262626]">
      <div className="mb-5">
        <label className="block text-gray-700 dark:text-gray-300">Tell us about your business update</label>
        <input
          value={businessUpdate}
          onChange={(e) => setbusinessUpdate(e.target.value)}
          placeholder="E.g, We are excited to announce the launch of our new product line!"
      ...
      <div className="mt-5">
        {isLoading ? (
            ...
            <div ref={resultsRef} className="border border-gray-300 rounded-md mt-6 p-5 relative">
                ...
                <h1 className="text-2xl text-gray-700 dark:text-gray-300 ">Generated Posts</h1>
