  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setgeneratedtheme(response.data.posts);
...
{ value: 'Zulu', label: 'Zulu' }
  ...
  return (
    <div className="m-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-md shadow-[var(--teal-color)]">
      <div className="mb-5">
        <label className="block text-[var(--primary-text-color)]">What’s Your Instagram Reel About?</label>
        <textarea
          value={theme}
          onChange={(e) => settheme(e.target.value)}
          placeholder="Please copy and paste or write What’s your Instagram Reel is about.
(E.g: Sharing my coffee recipe! ☕ #CoffeeLover.)"
