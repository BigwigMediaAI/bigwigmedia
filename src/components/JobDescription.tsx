...
export function JobDescription() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/generateJobDescription?clerkId=${userId}`, {
        jobTitle,
        responsibilities,
        qualifications,
        companyInfo,
      ...
      if (response.status === 200) {
        ...
        toast.error('Error generating job description. Please try again later.');
      }
    } catch (error) {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      console.error('Error sharing job description:', err);
    }
  };
    ...
    <div className="m-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-xl dark:bg-[#262626]">
      ...
      <div className="mb-5">
        ...
        <input
          ...
          placeholder="E.g, Design, develop, and maintain software applications."
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:text-gray-300 p-3 mb-4"
        />
      </div>
      <div className="mb-5">
      ...
      <div className="mb-5">
        <label className="block text-gray-700 dark:text-gray-300">CompanyInfo</label>
        <input
          value={companyInfo}
          onChange={(e) => setCompanyInfo(e.target.value)}
          placeholder="E.g, Tech Innovators Inc. is a leading software development company."
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:text-gray-300 p-3 mb-4"
        />
      </div>
      <div className="mb-5">
