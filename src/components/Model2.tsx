        ...
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="w-full md:w-1/2 md:mt-0 mt-4 flex flex-col justify-between">
            ...
            <div className="w-full flex justify-center pb-4 pl-4 pr-4">
              <Link to="/login" className="text-white text-center font-outfit md:text-lg font-semibold flex relative text-base py-3 px-10 justify-center items-center gap-4 flex-shrink-0 rounded-full bt-gradient disabled:opacity-60 hover:opacity-80 w-full">Login </Link>
            </div>
          </div>
        </div>
      </div>
