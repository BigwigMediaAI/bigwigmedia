...
    }
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/generateProductDescription?clerkId=${userId}`, {
        productName,
        productFeatures,
        targetAudience,
        tone,
    ...
    <div className="m-auto w-full max-w-4xl rounded-lg bg-[var(--white-color)] p-6 shadow-md shadow-[var(--teal-color)]">
      ...
      <div className="mb-5">
        ...
        <input
          ...
          placeholder="E.g, Heart rate monitor, GPS, Waterproof, Long battery life"
          className="mt-1 block w-full rounded-md border border-[var(--primary-text-color)] shadow-sm  p-3 mb-4"
        />
      </div>
      <div className="mb-5">
