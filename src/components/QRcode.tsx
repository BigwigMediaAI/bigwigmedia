  ...
  const handleGenerateQRCode = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        `${BASE_URL}/response/generate?clerkId=${userId}`,
        formData,
        {
          responseType: "blob",
        }
  ...
  return (
    <div className="m-auto w-full max-w-2xl rounded-lg bg-[var(--white-color)] p-6 shadow-md shadow-[var(--teal-color)]">
          ...
          <div className="w-1/2 pr-2">
            ...
            <div className="relative">
              ...
              <div className="flex space-x-2">
                {["#000000", "#FF0000", "#00FF00", "#0000FF", "#FFD700"].map(
                  (presetColor) => (
                    <div
                      key={presetColor}
                      ...
                      style={{
                        ...
                        borderColor:
                          color === presetColor ? "black" : "transparent",
                      }}
                    />
                  )
                )}
      ...
      {isLoading && (
        ...
        >
          <BigwigLoader />
          <p className="text-[var(--dark-gray-color)] text-ceter mt-5">
            Processing your data. Please bear with us as we ensure the best
            results for you...
          </p>
                    
        </div>
      ...
      {qrCode && (
        <div
          ref={qrCodeRef}
          className="mt-6 max-h-[500px] rounded-md p-5 overflow-y-auto border border-gray-300"
        >
