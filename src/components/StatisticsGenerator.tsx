...
export function StatisticsGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/generateStatistics`, {
        dataset,
  ...
  return (
    <div className="m-auto w-full max-w-4xl rounded-lg bg-white p-6 shadow-xl dark:bg-[#262626]">
      <div className="mb-5">
        <label className="block text-gray-700 dark:text-gray-300">Dataset</label>
        <input
          type="text"
          value={dataset}
      ...
      <div className="mb-5">
        <label className="block text-gray-700 dark:text-gray-300">Metrics</label>
        <input
          type="text"
          value={metrics}
      ...
      <div className="mt-5">
        {isLoading ? (
            ...
            <div ref={resultsRef} className="border border-gray-300 rounded-md mt-6 p-5 relative">
                ...
                <h1 className="text-2xl text-gray-700 dark:text-gray-300 ">Generated Statistics</h1>
