...
export function GenerateTiktokHastag() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/response/tiktokhastag?clerkId=${userId}`, {
        videoDescription,
        tone,
        language,
        outputCount,
    ...
    generatedPosts.length > 0 && (
      <div ref={resultsRef} className="border border-gray-300 rounded-md mt-6 p-5 relative ">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl text-gray-700 dark:text-gray-300">Generated Tiktok Hastags</h1>
