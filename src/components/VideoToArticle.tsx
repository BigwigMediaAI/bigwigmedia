...
import { Loader2, Share2, Download, Copy, UploadIcon } from 'lucide-react';
...
export function VideoToArticle() {
  ...
  const handleGenerate = async () => {
    ...
    try {
        ...
        const response = await axios.post(`${BASE_URL}/response/ytVideoToArticle?clerkId=${userId}`, formData, {
          headers: {
