    ...
    return (
        <div className="m-auto w-full max-w-4xl rounded-lg dark:bg-[#262626] bg-white p-6 shadow-lg">
            <div className="flex flex-col items-start">
                ...
                <Button
                    className="text-white text-center font-outfit md:text-lg font-semibold flex relative text-base py-3 px-10 justify-center items-center gap-4 flex-shrink-0 rounded-full bg-teal-400 hover:bg-teal-500 disabled:opacity-60  w-fit mx-auto mt-4"
            ...
            {outputs.length > 0 && (
                <div className="w-full mt-4">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <div className="flex gap-2 items-center">
                            <Button
                                className="rounded-md px-2 py-1 bg-white border border-gray-400 hover:bg-gray-600 text-gray-800 hover:text-white"
