...
const Landing = () => {
  ...
  useEffect(() => {
    ...
    if (!modalShown && isSignedIn && user?.createdAt) {
      // Check if user is signed in and createdAt is available
      ...
      if (differenceInDays <= 1) {
        // Show modal only if user is signed in and created within the last 1 days
      ...
      <div className="relative">
        ...
        <div className="w-full md:pt-10 absolute top-0 left-1/2 transform -translate-x-1/2 pt-4  flex flex-col items-center text-center space-y-2 md:space-y-4">
          ...
          <p className="px-5 text-sm md:text-xl font-medium text-white max-w-lg sm:max-w-2xl">
            Discover AI tools for social media, marketing, and more—boost
          ...
          <div className="content flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="left md:w-1/2 p-6 rounded-lg">
              ...
              <p className="mb-6 text-md text-gray-700 text-justify leading-relaxed">
                Our platform offers an extensive collection of over 230 tools
                designed to enhance productivity and creativity. From image
                generation and prompt creators to marketing and email tools, we
                provide everything you need to streamline your workflow.
              </p>
              <p className="mb-6 text-md text-gray-700 text-justify leading-relaxed">
                Whether you’re looking for HR solutions, video editing tools,
                file converters, or QR code generators, we’ve got you covered.
                Discover how our versatile tools can help you achieve your goals
        ...
        <div className="w-full p-5 md:p-14 flex flex-col-reverse md:flex-row gap-5 md:gap-8 mt-10 bg-gradient-to-r from-indigo-900 via-gray-900 to-indigo-900 text-center md:text-left text-white">
          ...
          <div className="p-5 md:p-10 flex flex-col justify-center">
            <h2 className="text-xl md:text-3xl font-bold mb-4">
              Get Started with Bigwigmedia.ai
            </h2>
            <p className="text-lg mb-6">
              Discover powerful AI tools designed to transform your workflow and
              boost productivity.
            </p>
            <ul className="text-md mb-6 space-y-2">
              <li>
                🎉 <span className="font-semibold">30 Credits Free</span>{" "}
              </li>
              <li>
            ...
            <button
              className="bg-[var(--teal-color)] text-white py-3 rounded-full font-semibold hover:bg-white hover:text-[var(--teal-color)] border border-white md:w-1/3"
              onClick={handleExploreClick}
            >
