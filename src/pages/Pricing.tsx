  ...
  return (
    <div className='mt-20'>
      ...
      <div className='px-5 mb-10'>
        ...
        <h1 className='text-center text-[var(--primary-text-color)]'>Experience immediate results with our all-inclusive pricing. Try it for <span className='text-lg sm:text-md lg:text-xl bg-gradient-to-r from-[var(--teal-color)] via-blue-500 to-indigo-600 text-transparent bg-clip-text font-bold'>FREE NOW</span>!</h1>
      </div>
