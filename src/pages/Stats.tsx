        ...
        <div className="grid p-4 grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="text-center flex flex-col justify-center items-center">
            <div className="flex items-center gap-2">
              ...
              <p className="text-lg sm:text-md lg:text-xl text-[var(--teal-color)] font-outfit font-semibold">No.1</p>
            </div>
          ...
          <div className="text-center flex flex-col justify-center items-center">
            <div className="flex items-center gap-2">
              ...
              <p className="text-lg sm:text-md lg:text-xl text-[var(--teal-color)] font-outfit font-semibold">20+</p>
            </div>
            <p className="text-sm sm:text-md lg:text-lg text-[var(--dark-gray-color)]">Countries</p>
          </div>
          <div className="text-center flex flex-col justify-center items-center">
            <p className="text-lg sm:text-md lg:text-xl text-[var(--teal-color)] font-outfit font-semibold">1.4M+</p>
            <p className="text-sm sm:text-md lg:text-lg text-[var(--dark-gray-color)]">Happy Users</p>
          </div>
          <div className="text-center flex flex-col justify-center items-center">
            <p className="text-lg sm:text-md lg:text-xl text-[var(--teal-color)] font-outfit font-semibold">8.5M+</p>
            <p className="text-sm sm:text-md lg:text-lg text-[var(--dark-gray-color)]">Files Converted</p>
          </div>
          <div className="text-center flex flex-col justify-center items-center">
            <p className="text-lg sm:text-md lg:text-xl text-[var(--teal-color)] font-outfit font-semibold">150+</p>
            <p className="text-sm sm:text-md lg:text-lg text-[var(--dark-gray-color)]">Online Tools</p>
          </div>
          <div className="text-center flex flex-col justify-center items-center">
            <p className="text-lg sm:text-md lg:text-xl text-[var(--teal-color)] font-outfit font-semibold">12.6M+</p>
