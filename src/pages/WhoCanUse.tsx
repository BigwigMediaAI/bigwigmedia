...
const WhoCanUseIt = () => {
    ...
    return (
        <div className="mt-20   text-black dark:text-gray-200 text-center font-outfit text-[18px] md:text-[20px] lg:text-[30px] font-normal md:max-w-5xl max-w-7xl mx-auto flex gap-2 justify-center flex-wrap">
