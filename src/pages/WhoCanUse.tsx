...
const WhoCanUseIt = () => {
  ...
  return (
    <div className="mt-6 md:mt-14 text-black dark:text-gray-200 text-center font-outfit text-[18px] md:text-[20px] lg:text-[30px] font-normal md:max-w-5xl max-w-7xl mx-auto flex flex-col items-center">
